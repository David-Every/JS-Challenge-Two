...
var minNo = 1;
var maxNo = 1085;
var num = Math.floor(Math.random() * maxNo);
var idNum = num; // random num between minNo and maxNo

console.log("num is = ".concat(num));
var currentImage = "https://picsum.photos/id/".concat(idNum, "/500/400"); // adjust height and width according to browser size

$body = $("body");
$body.css("margin", "0");
$("#image").css("background-image", "url(".concat(currentImage, ")"));
/**
 * Sidebar adjustments
 */
// $("body").
